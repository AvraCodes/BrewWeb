      ...
      <h3 ref={textRef} className={clsx(styles.text, 'h3')}>
        {!isLoading && (
          <TextOpacity textRef={textRef.current} trigger={rootRef.current}>
            We prioritize features that support your business goals. Clear communication, reliable execution, and systems built to perform under real-world conditions.
          </TextOpacity>
        )}
      </h3>
    </section>
