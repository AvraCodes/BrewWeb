...
const seo = {
  title: 'BrewWeb - About Us',
  description: 'Learn about BrewWeb, a web and app development agency founded by Avra Paul and Nomesh Singh in Kolkata, delivering production-ready solutions.',
  keywords: [
    'BrewWeb',
    'About BrewWeb',
