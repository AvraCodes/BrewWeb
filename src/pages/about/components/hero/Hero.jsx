  ...
  return (
    <section ref={rootRef} className={clsx(styles.root, 'layout-block-inner')}>
      <header className={styles.titleContainer}>
        <h2 className={clsx(styles.title, 'h2')}>Building reliable web and app solutions from concept to deployment.</h2>
      </header>
      <div className={styles.wrapper}>
        <div ref={heroImageRef} className={styles.imageContainer} style={{ display: 'none' }}>
          <Image priority quality={100} src="/BrewWeb/back.webp" sizes="100%" fill alt="BrewWeb" />
        </div>
      </div>
    </section>
  );
